'use strict';
/* Corrected roster labels keep the same IDs and preserve existing seating. */
(() => {
  const corrected = {
    '9A':['Isabella','Martin','Lucia','Lucas','Matias','Maria Adelaida','Alejandro','Samuel','David','Emilia','Maria Camila','Juana','Juliana','Pablo','Lorenzo','Juan Sebastian','Maria Jose','Mariana','Juan Jose','Sofia','Maria Del Rosario'],
    '9B':['Antonia C','Elena','Samuel','Santiago','Julieta','Gabriela','Jose Jacobo','Antonia A','Mariana','Matías','Valentina','Juana',,'Maria Antonia','Salomon','Jacobo O','Sofia','Jacobo P','Tomas'],
    '9C':['Mariana B','Sara Sofia','Juan Sebastián','Alejandro','Isabella F','Antonia G','Jeronimo','Ana Lucia','Matias','Belen','Isabella L','Dianita ','Sara','Maria Jose','Juan Diego','Mariana T','Pablo','Emmanuel','David','Catalina']
  };
  ...
  const DEFAULTS=[{x:28,y:33},{x:72,y:33},{x:28,y:66},{x:72,y:66},{x:50,y:33},{x:50,y:66},{x:36,y:50},{x:64,y:50}];
