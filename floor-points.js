...
(() => {
  const corrected = {
    ...
    '9B':['Antonia C','Elena','Samuel','Santiago','Maria Adelaida','Julieta','Gabriela','Jose Jacobo','Antonia A','Mariana','Matías','Valentina','Juana',,'Maria Antonia','Salomon','Jacobo O','Sofia','Jacobo P','Tomas'],
